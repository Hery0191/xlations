...
class tvshows:
    ...
    def genres(self):
        genres = [
            ('[COLOR darkgray]Action[/COLOR]', 'action', True),
            ('[COLOR darkgray]Adventure[/COLOR]', 'adventure', True),
            ('[COLOR darkgray]Animation[/COLOR]', 'animation', True),
            ('[COLOR darkgray]Anime[/COLOR]', 'anime', False),
            ('[COLOR darkgray]Biography[/COLOR]', 'biography', True),
            ('[COLOR darkgray]Comedy[/COLOR]', 'comedy', True),
            ('[COLOR darkgray]Crime[/COLOR]', 'crime', True),
            ('[COLOR darkgray]Drama[/COLOR]', 'drama', True),
            ('[COLOR darkgray]Family[/COLOR]', 'family', True),
            ('[COLOR darkgray]Fantasy[/COLOR]', 'fantasy', True),
            ('[COLOR darkgray]Game-Show[/COLOR]', 'game_show', True),
            ('[COLOR darkgray]History[/COLOR]', 'history', True),
            ('[COLOR darkgray]Horror[/COLOR]', 'horror', True),
            ('[COLOR darkgray]Music[/COLOR] ', 'music', True),
            ('[COLOR darkgray]Musical[/COLOR]', 'musical', True),
            ('[COLOR darkgray]Mystery[/COLOR]', 'mystery', True),
            ('[COLOR darkgray]News[/COLOR]', 'news', True),
            ('[COLOR darkgray]Reality-TV[/COLOR]', 'reality_tv', True),
            ('[COLOR darkgray]Romance[/COLOR]', 'romance', True),
            ('[COLOR darkgray]Science Fiction[/COLOR]', 'sci_fi', True),
            ('[COLOR darkgray]Sport[/COLOR]', 'sport', True),
            ('[COLOR darkgray]Talk-Show[/COLOR]', 'talk_show', True),
            ('[COLOR darkgray]Thriller[/COLOR]', 'thriller', True),
            ('[COLOR darkgray]War[/COLOR]', 'war', True),
            ('[COLOR darkgray]Western[/COLOR]', 'western', True)
        ]
    ...
    def networks(self):
        networks = [
        ('[COLOR white]A&E[/COLOR]', '/networks/29/ae'),
        ('[COLOR white]ABC[/COLOR]', '/networks/3/abc'),
        ('[COLOR white]AMC[/COLOR]', '/networks/20/amc'),
        ('[COLOR white]AT-X[/COLOR]', '/networks/167/at-x'),
        ('[COLOR white]Adult Swim[/COLOR]', '/networks/10/adult-swim'),
        ('[COLOR white]Amazon[/COLOR]', '/webchannels/3/amazon'),
        ('[COLOR white]Animal Planet[/COLOR]', '/networks/92/animal-planet'),
        ('[COLOR white]Audience[/COLOR]', '/networks/31/audience-network'),
        ('[COLOR white]BBC America[/COLOR]', '/networks/15/bbc-america'),
        ('[COLOR white]BBC Four[/COLOR]', '/networks/51/bbc-four'),
        ('[COLOR white]BBC One[/COLOR]', '/networks/12/bbc-one'),
        ('[COLOR white]BBC Three[/COLOR]', '/webchannels/71/bbc-three'),
        ('[COLOR white]BBC Two[/COLOR]', '/networks/37/bbc-two'),
        ('[COLOR white]BET[/COLOR]', '/networks/56/bet'),
        ('[COLOR white]Bravo[/COLOR]', '/networks/52/bravo'),
        ('[COLOR white]CBC[/COLOR]', '/networks/36/cbc'),
        ('[COLOR white]CBS[/COLOR]', '/networks/2/cbs'),
        ('[COLOR white]CTV[/COLOR]', '/networks/48/ctv'),
        ('[COLOR white]CW[/COLOR]', '/networks/5/the-cw'),
        ('[COLOR white]CW Seed[/COLOR]', '/webchannels/13/cw-seed'),
        ('[COLOR white]Cartoon Network[/COLOR]', '/networks/11/cartoon-network'),
        ('[COLOR white]Channel 4[/COLOR]', '/networks/45/channel-4'),
        ('[COLOR white]Channel 5[/COLOR]', '/networks/135/channel-5'),
        ('[COLOR white]Cinemax[/COLOR]', '/networks/19/cinemax'),
        ('[COLOR white]Comedy Central[/COLOR]', '/networks/23/comedy-central'),
        ('[COLOR white]Crackle[/COLOR]', '/webchannels/4/crackle'),
        ('[COLOR white]Discovery Channel[/COLOR]', '/networks/66/discovery-channel'),
        ('[COLOR white]Discovery ID[/COLOR]', '/networks/89/investigation-discovery'),
        ('[COLOR white]Disney Channel[/COLOR]', '/networks/78/disney-channel'),
        ('[COLOR white]Disney XD[/COLOR]', '/networks/25/disney-xd'),
        ('[COLOR white]E! Entertainment[/COLOR]', '/networks/43/e'),
        ('[COLOR white]E4[/COLOR]', '/networks/41/e4'),
        ('[COLOR white]FOX[/COLOR]', '/networks/4/fox'),
        ('[COLOR white]FX[/COLOR]', '/networks/13/fx'),
        ('[COLOR white]Freeform[/COLOR]', '/networks/26/freeform'),
        ('[COLOR white]HBO[/COLOR]', '/networks/8/hbo'),
        ('[COLOR white]HGTV[/COLOR]', '/networks/192/hgtv'),
        ('[COLOR white]Hallmark[/COLOR]', '/networks/50/hallmark-channel'),
        ('[COLOR white]History Channel[/COLOR]', '/networks/53/history'),
        ('[COLOR white]ITV[/COLOR]', '/networks/35/itv'),
        ('[COLOR white]Lifetime[/COLOR]', '/networks/18/lifetime'),
        ('[COLOR white]MTV[/COLOR]', '/networks/22/mtv'),
        ('[COLOR white]NBC[/COLOR]', '/networks/1/nbc'),
        ('[COLOR white]National Geographic[/COLOR]', '/networks/42/national-geographic-channel'),
        ('[COLOR white]Netflix[/COLOR]', '/webchannels/1/netflix'),
        ('[COLOR white]Nickelodeon[/COLOR]', '/networks/27/nickelodeon'),
        ('[COLOR white]PBS[/COLOR]', '/networks/85/pbs'),
        ('[COLOR white]Showtime[/COLOR]', '/networks/9/showtime'),
        ('[COLOR white]Sky[/COLOR]1', '/networks/63/sky-1'),
        ('[COLOR white]Starz[/COLOR]', '/networks/17/starz'),
        ('[COLOR white]Sundance[/COLOR]', '/networks/33/sundance-tv'),
        ('[COLOR white]Syfy[/COLOR]', '/networks/16/syfy'),
        ('[COLOR white]TBS[/COLOR]', '/networks/32/tbs'),
        ('[COLOR white]TLC[/COLOR]', '/networks/80/tlc'),
        ('[COLOR white]TNT[/COLOR]', '/networks/14/tnt'),
        ('[COLOR white]TV Land[/COLOR]', '/networks/57/tvland'),
        ('[COLOR white]Travel Channel[/COLOR]', '/networks/82/travel-channel'),
        ('[COLOR white]TruTV[/COLOR]', '/networks/84/trutv'),
        ('[COLOR white]USA[/COLOR]', '/networks/30/usa-network'),
        ('[COLOR white]VH1[/COLOR]', '/networks/55/vh1'),
        ('[COLOR white]WGN[/COLOR]', '/networks/28/wgn-america')
        ]
