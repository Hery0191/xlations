...
class navigator:
    def root(self):
        ...
        if not control.setting('lists.widget') == '0':
            self.addDirectoryItem('My Genesis Reborn Movies', 'mymovieNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem('My Genesis Reborn TV Shows', 'mytvNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')
    ...
    def movies(self, lite=False):
        ...
        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem('My Genesis Reborn Movies', 'mymovieliteNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem('Genesis Reborn Exclusive', 'tvshows&url=rating', 'populars.png', 'DefaultTVShows.png')
        ...
        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem('Genesis Reborn My TV Shows', 'mytvliteNavigator', 'airing-today.png', 'DefaultVideoPlaylists.png')
